...
const ProjectsDropdown = ({ projects, setProjectId }) => {
  ...
  return (
    <div className="container flex flex-wrap items-center justify-between mx-auto relative">
        <button onClick={() => setIsOpen(!isOpen)} type="button" className="inline-flex items-center ml-3 p-1 px-2 text-gray-500 rounded-lg border-2 border-gray-300 hover:bg-gray-300 focus:outline-none">
          <p>Select projects</p>
        ...
        {isOpen && 
          <div className="w-fit absolute top-48 right-0 md:top-9 md:left-3 z-50 rounded-lg">

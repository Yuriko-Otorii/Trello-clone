...
const DetailPageModal = ({ setShowDetailModal, taskId, boardId }) => {
    ...
    const deleteAlert = async (message, taskId, boardId) => {
                  ...
                  <div className="flex flex-col">                      
                    <div className="flex items-center justify-between mt-3">
                      ...
                      <div className="flex justify-end items-center gap-1">
                        ...
                        <svg onClick={() => deleteAlert(`task ${taskInfo.taskTitle}`, taskInfo._id, boardId)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 md:w-6 md:h-6 text-gray-500 hover:text-red-700">
